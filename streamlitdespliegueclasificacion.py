...
Original file is located at
    https://colab.research.google.com/drive/1pgFSb-o4uKlnft2UZ_Txnvgqn_q4UtcX
"""
...
try:
    encoder = joblib.load('/content/drive/MyDrive/EjerciciosML/save_models/onehot_encoder.pkl')
    scaler = joblib.load('/content/drive/MyDrive/EjerciciosML/save_models/standard_scaler.pkl')
    nnm_model = joblib.load('/content/drive/MyDrive/EjerciciosML/save_models/neural_network_model.pkl')
    rf_model = joblib.load('/content/drive/MyDrive/EjerciciosML/save_models/random_forest_model.pkl')
    svm_model = joblib.load('/content/drive/MyDrive/EjerciciosML/save_models/svm_model.pkl')
